 ...
 * profile/prefs, and cannot change their role (role is omitted here).
 *
 * Credentials (email, phone, password) live in ./credential-actions.
 */
...
export async function updateOwnProfileAction(
  ...
  // The name is shown from the session in the header and dashboard greeting,
  // so the cookie has to catch up or the student renames themselves and sees
  // the old name until their next sign-in.
